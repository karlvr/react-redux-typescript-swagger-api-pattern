...
export const StoreApiFetchParamCreator = {
     ...
     */
    deleteOrder(params: {  "orderId": number; }, options?: any): FetchArgs {
...
export const StoreApiFp = {
     ...
     * @param orderId ID of the order that needs to be deleted
     */
    deleteOrder(params: { "orderId": number;  }, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
...
export class StoreApi extends BaseAPI {
     ...
     * @param orderId ID of the order that needs to be deleted
     */
    deleteOrder(params: {  "orderId": number; }, options?: any) {
